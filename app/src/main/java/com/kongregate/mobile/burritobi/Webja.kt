...
import com.kongregate.mobile.burritobi.Appja.Companion.MAIN_ID
import com.kongregate.mobile.burritobi.databinding.ActivityWebjaBinding
...
class Webja : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebjaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebjaBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.kongregate.mobile.burritobi"
        ...
        val first = "http://"
        val second = "rubymonkey.xyz/go.php?to=2&"
